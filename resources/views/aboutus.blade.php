            ...
            <div class="details">
                <!-- Navbar -->
                    <header class="shadow-lg">
                        <div class="content1">
                            <nav>
                                <h1 class="brand"><a href="homepage"><img src="/img/letterR.png" alt="">Field-It</a></h1>
                                <ul>
                            ...
                            <hr class="line-black">
                            <div class="row text-center mContent">
                                    <div class="col-12">
                                        <p class="container">
                                            <b class="container sub_topic1">ABOUT US</b>
                                            <br>
                                            ...
                                            <br>
                                            <b class="sub_topic1">For more information and reservations</b>
                                            <br>
                                            <p>
                                                    www.field-it.com
                                                    <br>
