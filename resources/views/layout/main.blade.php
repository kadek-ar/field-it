                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                        <li class="nav-item d-flex align-items-baseline">
                            <div class="dropdown">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-white mt-2 bi bi-person-circle" width="26" height="26" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false" fill="currentColor" viewBox="0 0 16 16">
